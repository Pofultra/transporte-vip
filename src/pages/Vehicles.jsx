...
const translations = {
  en: {
    ...
    vehicles: [
      ...
      { name: "Mercedes Sprinter", passengers: 12, transmission: "Mechanical", images: [sprinter1, sprinter2] },
  ...
  es: {
    ...
    vehicles: [
      ...
      { name: "Mercedes Sprinter", passengers: 12, transmission: "Mecánica", images: [sprinter1, sprinter2] },
  ...
  de: {
    ...
    vehicles: [
      ...
      { name: "Mercedes Sprinter", passengers: 12, transmission: "Manuell", images: [sprinter1, sprinter2] },
  ...
  fr: {
    ...
    vehicles: [
      ...
      { name: "Mercedes Sprinter", passengers: 12, transmission: "Manuelle", images: [sprinter1, sprinter2] },
